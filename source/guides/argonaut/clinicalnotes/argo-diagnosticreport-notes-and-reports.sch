...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport/f:status">
      <sch:assert test="not(f:DiagnosticReport/f:status[@value=('final','amended','appended','corrected')]) or (f:DiagnosticReport/f:conclusion or f:DiagnosticReport/f:presentedForm or f:DiagnosticReport/f:codedDiagnosis)">When DiagnosticReport.status is final/amended/corrected/appended, the presentedForm, conclusion or codedDiagnosis must be present</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
