...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="not(exists(f:reasonNotPerformed)) or f:notPerformed/@value=true()">Reason not performed is only permitted if notPerformed indicator is true (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
